...
class TestPerformanceRegression:
    ...
    def test_performance_regression(self, benchmark):
        ...
        assert result.stats.mean < historical_mean * 1.1, "Performance regression detected"
